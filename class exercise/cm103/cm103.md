...
``` r
map_dfr(got_chars, `[`, desired_info) # row binding
```
...
``` r
map_dfc(got_chars, `[`, desired_info) # column binding
```

    ## # A tibble: 1 x 60
    ##   name   born  name1 born1 name2 born2 name3 born3 name4 born4 name5 born5
    ##   <chr>  <chr> <chr> <chr> <chr> <chr> <chr> <chr> <chr> <chr> <chr> <chr>
    ## 1 Theon~ In 2~ Tyri~ In 2~ Vict~ In 2~ Will  ""    Areo~ In 2~ Chett At H~
    ## # ... with 48 more variables: name6 <chr>, born6 <chr>, name7 <chr>,
    ## #   born7 <chr>, name8 <chr>, born8 <chr>, name9 <chr>, born9 <chr>,
    ## #   name10 <chr>, born10 <chr>, name11 <chr>, born11 <chr>, name12 <chr>,
    ## #   born12 <chr>, name13 <chr>, born13 <chr>, name14 <chr>, born14 <chr>,
    ## #   name15 <chr>, born15 <chr>, name16 <chr>, born16 <chr>, name17 <chr>,
    ## #   born17 <chr>, name18 <chr>, born18 <chr>, name19 <chr>, born19 <chr>,
    ## #   name20 <chr>, born20 <chr>, name21 <chr>, born21 <chr>, name22 <chr>,
    ## #   born22 <chr>, name23 <chr>, born23 <chr>, name24 <chr>, born24 <chr>,
    ## #   name25 <chr>, born25 <chr>, name26 <chr>, born26 <chr>, name27 <chr>,
    ## #   born27 <chr>, name28 <chr>, born28 <chr>, name29 <chr>, born29 <chr>
